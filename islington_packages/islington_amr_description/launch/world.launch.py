...
def generate_launch_description():
  ...
  package_name = 'islington_amr_description'
  robot_name_in_model = 'islington_amr'
  rviz_config_file_path = 'launch/rviz.rviz'
  urdf_file_path = 'urdf/islington_amr.xacro'
  world_file_path = 'world/office/office/service.world'
